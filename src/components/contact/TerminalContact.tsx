...
const TerminalContact = () => {
  ...
  return (
    <section
      ...
      className="px-4 py-12 max-w-xl mx-auto"
    >
      <TerminalHeader />
      <div
        ref={containerRef}
        ...
        className="h-auto px-10 pb-10 bg-zinc-800 backdrop-blur rounded-b-lg w-full max-w-3xl mx-auto overflow-y-scroll shadow-xl cursor-text font-mono"
      >
    ...
    <>
      {complete ? (
        ...
        <div className="flex gap-2 mt-6">
          <button
            onClick={handleReset}
            className="px-4 py-2 text-base hover:opacity-90 transition-opacity rounded bg-slate-100 text-black"
          >
            Reiniciar
          </button>
          <button
            onClick={handleSend}
            className="px-4 py-2 text-base hover:opacity-90 transition-opacity rounded bg-[#FF0099] text-white"
          >
            Enviar
          </button>
        </div>
